...
# Custom User model
AUTH_USER_MODEL = 'account_verification.User'
...
if not (AUTHY_API_KEY and TWILIO_ACCOUNT_SID and TWILIO_AUTH_TOKEN and TWILIO_NUMBER):
    missing_config_values = \
    """
    You must set the AUTHY_API_KEY, TWILIO_ACCOUNT_SID, TWILIO_AUTH_TOKEN, TWILIO_NUMBER, and environment variables to run this app.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'account_verification_django'
    }
}
